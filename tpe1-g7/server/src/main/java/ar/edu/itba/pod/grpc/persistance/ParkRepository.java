...
public class ParkRepository {
    ...
    //Con att, dia y capacidad, genera la capacidad para todos los slots de ese día. Hace falta validar
    ...
    public void addPass(AttractionPass pass) throws RuntimeException{
        lockWrite(passLock);
        ...
        for(Reservation r : attReservs){
            ...
            if(vacants > 0){
                ...
                if(firstAvailable != null){
                    ...
                    // Este ver si se hizo donde corresponde
                    r.setStatus(PENDING);
